...
// node_modules/react-auth-kit/RxTokenObject.js
var require_RxTokenObject = __commonJS({
  "node_modules/react-auth-kit/RxTokenObject.js"(exports) {
    "use strict";
    "use client";
    ...
    var TokenObject = class {
      constructor(authStorageName, authStorageType, refreshTokenName, debug, cookieDomain, cookieSecure) {
          ...
          if (this.isUsingRefreshToken) {
            if (obj.auth === null) {
              ...
              try {
                ...
                if (refreshExpireTime > /* @__PURE__ */ new Date()) {
                  obj = {
                    ...obj,
                    refresh: {
                      "token": data.refresh,
        ...
        __publicField(this, "initialToken_", () => {
        ...
        __publicField(this, "initialCookieToken_", () => {
        ...
        __publicField(this, "initialLSToken_", () => {
        ...
        __publicField(this, "checkTokenExist_", (authToken, authTokenType, stateCookie, refreshToken) => {
      ...
      stateCookie: ${stateCookie}, refreshToken: ${refreshToken}`);
          ...
          = ${this.isUsingRefreshToken} refrehToken - ${refreshToken}`);
              ...
              if (refreshTokenExpiresAt < /* @__PURE__ */ new Date()) {
        ...
        __publicField(this, "parseJwt", (token) => {
        ...
        __publicField(this, "getExpireDateTime", (token) => {
        ...
        __publicField(this, "syncTokens", (authState) => {
          if (authState.auth) {
        ...
        __publicField(this, "setAuthToken", (authToken, authTokenType, authState) => {
          if (this.authStorageType === "cookie") {
            const expiresAt = this.getExpireDateTime(authToken);
        ...
        __publicField(this, "setRefreshToken", (refreshToken) => {
          if (this.authStorageType === "cookie") {
        ...
        __publicField(this, "removeAllToken", () => {
          if (this.authStorageType === "cookie") {
        ...
        __publicField(this, "removeAllCookieToken_", () => {
        ...
        __publicField(this, "removeAllLSToken_", () => {
        ...
        __publicField(this, "removeAuthCookie", () => {
          _jsCookie.default.remove(this.authStorageName, {
            domain: this.cookieDomain,
            secure: this.cookieSecure
          });
        ...
        __publicField(this, "removeAuthToken", () => {
          localStorage.removeItem(this.authStorageName);
          localStorage.removeItem(this.authStorageTypeName);
          localStorage.removeItem(this.stateStorageName);
        });
        __publicField(this, "removeRefresh", () => {
          if (this.authStorageType === "cookie") {
        ...
        __publicField(this, "removeRefreshCookie", () => {
          if (this.isUsingRefreshToken && !!this.refreshTokenName) {
            _jsCookie.default.remove(this.refreshTokenName, {
              domain: this.cookieDomain,
              secure: this.cookieSecure
        ...
        __publicField(this, "removeRefreshLocalStorage", () => {
          if (this.isUsingRefreshToken && !!this.refreshTokenName) {
            localStorage.removeItem(this.refreshTokenName);
          }
        });
        __publicField(this, "log", (msg, ...optionalParams) => {
          if (this.debug) {
...
// node_modules/react-auth-kit/createStore.js
var require_createStore = __commonJS({
  "node_modules/react-auth-kit/createStore.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.default = createStore;
    var _RxTokenObject = _interopRequireDefault(require_RxTokenObject());
    var _errors = require_errors();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    function createStore(params) {
      if (params.authType === "cookie" && (params.cookieDomain === void 0 || params.cookieSecure === void 0)) {
      ...
      const tokenObject = new _RxTokenObject.default(params.authName, params.authType, refreshTokenName, params.debug === void 0 ? false : params.debug, params.cookieDomain, params.cookieSecure);
      return {
        tokenObject,
...
export default require_createStore();
/*! Bundled license information:

js-cookie/dist/js.cookie.js:
  (*! js-cookie v3.0.5 | MIT *)
*/
//# sourceMappingURL=react-auth-kit_createStore.js.map
