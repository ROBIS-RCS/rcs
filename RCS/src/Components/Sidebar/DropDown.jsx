    ...
    <div className="w-full h-full flex flex-col items-center justify-center">
        <div className='w-[calc(100%-30px)] px-2 py-3 flex justify-between items-center bg-black rounded-[5px]' onClick={toggleArrow}>
            <span className="flex items-center justify-center gap-5">
                <img src={System} alt="" className="w-[22%]" />
               <p className="text-white font-semibold text-[20px]">{props.title}</p> 
            </span>
            <img src={DropArrow} alt="" className={!clicked ?"duration-500 rotate-0" : "rotate-180 duration-500"} />
        </div>
