    ...
    return (
        <div className="w-full p-4 flex flex-wrap align-top gap-4 rounded-[15px]">
            { profiles.map((cont, index) => (
                <div key={index} className="w-[400px] h-[180px] rounded-[10px] flex flex-col p-5 items-center bg-gradient-to-tl from-gray-300  to-red-100 justify-between duration-300 hover:shadow-xl">
            ...
            <div className="w-[400px] h-[200px] rounded-[10px] flex items-center justify-center hover:shadow-xl duration-200 border-2">
